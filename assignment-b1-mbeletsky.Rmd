...
I've included "datateachr" so that we have access to the "vancouver_trees" dataset I'll be using as an example. We'll be using "tidyverse" to take advantage of the "dplyr" package. I've loaded "testthat" for the tests we're going to run later on the package created in this assignment. 
